...
HRESULT STDMETHODCALLTYPE ButtonGlow::MyCTopLevelWindow_ValidateVisual(uDwm::CTopLevelWindow* This)
{
...
void STDMETHODCALLTYPE ButtonGlow::MyCTopLevelWindow_Destructor(uDwm::CTopLevelWindow* This)
{
